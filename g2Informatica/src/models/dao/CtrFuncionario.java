        ...
        if(p instanceof Funcionario)
        {
            ...
            try
            {
                if(rs.next())
                {
                    ...
                    p = new Funcionario(rs.getInt("fun_cod"), rs.getString("fun_nome"), rs.getString("fun_email"), rs.getString("fun_telefone"), rs.getString("fun_cpf"), rs.getString("fun_rg"), rs.getInt("Endereco_end_cod"), rs.getString("fun_id_loguin"), rs.getString("fun_senha"), rs.getString("fun_tipo"), rs.getString("fun_nivel"));
